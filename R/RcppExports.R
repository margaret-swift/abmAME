...
cpp_abm_simulate <- function(startx, starty, timesteps, ndes, nopt, shelter_locs_x, shelter_locs_y, sSiteSize, home_center_x, home_center_y, home_radius, avoidPoints_x, avoidPoints_y, k_desRange, s_desRange, mu_desDir, k_desDir, destinationTrans, destinationMod, avoidTrans, avoidMod, k_step, s_step, mu_angle, k_angle, rescale, b0_Options, b1_Options, b2_Options, rest_Cycle_A, rest_Cycle_M, rest_Cycle_PHI, rest_Cycle_TAU, addCycles, add_Cycle_A, add_Cycle_M, add_Cycle_PHI, add_Cycle_TAU, shelterMatrix, forageMatrix, moveMatrix, envExt, barriers) {
    .Call('_abmAME_cpp_abm_simulate', PACKAGE = 'abmAME', startx, starty, timesteps, ndes, nopt, shelter_locs_x, shelter_locs_y, sSiteSize, home_center_x, home_center_y, home_radius, avoidPoints_x, avoidPoints_y, k_desRange, s_desRange, mu_desDir, k_desDir, destinationTrans, destinationMod, avoidTrans, avoidMod, k_step, s_step, mu_angle, k_angle, rescale, b0_Options, b1_Options, b2_Options, rest_Cycle_A, rest_Cycle_M, rest_Cycle_PHI, rest_Cycle_TAU, addCycles, add_Cycle_A, add_Cycle_M, add_Cycle_PHI, add_Cycle_TAU, shelterMatrix, forageMatrix, moveMatrix, envExt, barriers)
}
...
cpp_check_intersection <- function(origin, target, BARRIERS) {
    .Call('_abmAME_cpp_check_intersection', PACKAGE = 'abmAME', origin, target, BARRIERS)
}
...
cpp_cycle_draw <- function(TIME, A, M, PHI, TAU) {
    .Call('_abmAME_cpp_cycle_draw', PACKAGE = 'abmAME', TIME, A, M, PHI, TAU)
}
...
cpp_get_values <- function(MATRIX, XLOCS, YLOCS) {
    .Call('_abmAME_cpp_get_values', PACKAGE = 'abmAME', MATRIX, XLOCS, YLOCS)
}
...
#'   begins at zero.
cpp_get_values_rast <- function(RASTER, ENVEXT, XLOCS, YLOCS) {
    .Call('_abmAME_cpp_get_values_rast', PACKAGE = 'abmAME', RASTER, ENVEXT, XLOCS, YLOCS)
}
...
cpp_max <- function(x) {
    .Call('_abmAME_cpp_max', PACKAGE = 'abmAME', x)
}

cpp_min <- function(x) {
    .Call('_abmAME_cpp_min', PACKAGE = 'abmAME', x)
}
...
cpp_sample_options <- function(W) {
    .Call('_abmAME_cpp_sample_options', PACKAGE = 'abmAME', W)
}
...
cpp_vonmises <- function(N, MU, KAPPA) {
    .Call('_abmAME_cpp_vonmises', PACKAGE = 'abmAME', N, MU, KAPPA)
}
