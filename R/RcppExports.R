...
cpp_check_intersection <- function(origin, target, fence_x1, fence_x2, fence_y1, fence_y2, p_cross) {
    .Call('_abmFences_cpp_check_intersection', PACKAGE = 'abmFences', origin, target, fence_x1, fence_x2, fence_y1, fence_y2, p_cross)
}
