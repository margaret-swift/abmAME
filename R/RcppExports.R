...
cpp_abm_simulate <- function(startx, starty, timesteps, ndes, nopt, shelter_locs_x, shelter_locs_y, sSiteSize, avoidPoints_x, avoidPoints_y, k_desRange, s_desRange, mu_desDir, k_desDir, destinationTrans, destinationMod, avoidTrans, avoidMod, k_step, s_step, mu_angle, k_angle, rescale, b0_Options, b1_Options, b2_Options, rest_Cycle_A, rest_Cycle_M, rest_Cycle_PHI, rest_Cycle_TAU, addCycles, add_Cycle_A, add_Cycle_M, add_Cycle_PHI, add_Cycle_TAU, shelterMatrix, forageMatrix, moveMatrix, envExt, barrier_x1, barrier_x2, barrier_y1, barrier_y2, p_cross) {
    .Call('_abmFences_cpp_abm_simulate', PACKAGE = 'abmFences', startx, starty, timesteps, ndes, nopt, shelter_locs_x, shelter_locs_y, sSiteSize, avoidPoints_x, avoidPoints_y, k_desRange, s_desRange, mu_desDir, k_desDir, destinationTrans, destinationMod, avoidTrans, avoidMod, k_step, s_step, mu_angle, k_angle, rescale, b0_Options, b1_Options, b2_Options, rest_Cycle_A, rest_Cycle_M, rest_Cycle_PHI, rest_Cycle_TAU, addCycles, add_Cycle_A, add_Cycle_M, add_Cycle_PHI, add_Cycle_TAU, shelterMatrix, forageMatrix, moveMatrix, envExt, barrier_x1, barrier_x2, barrier_y1, barrier_y2, p_cross)
}
...
cpp_check_intersection <- function(origin, target, barrier_x1, barrier_x2, barrier_y1, barrier_y2, p_cross) {
    .Call('_abmFences_cpp_check_intersection', PACKAGE = 'abmFences', origin, target, barrier_x1, barrier_x2, barrier_y1, barrier_y2, p_cross)
}
...
cpp_cycle_draw <- function(TIME, A, M, PHI, TAU) {
    .Call('_abmFences_cpp_cycle_draw', PACKAGE = 'abmFences', TIME, A, M, PHI, TAU)
}
...
cpp_get_values <- function(MATRIX, XLOCS, YLOCS) {
    .Call('_abmFences_cpp_get_values', PACKAGE = 'abmFences', MATRIX, XLOCS, YLOCS)
}
...
cpp_get_values_rast <- function(RASTER, ENVEXT, XLOCS, YLOCS) {
    .Call('_abmFences_cpp_get_values_rast', PACKAGE = 'abmFences', RASTER, ENVEXT, XLOCS, YLOCS)
}
...
cpp_max <- function(x) {
    .Call('_abmFences_cpp_max', PACKAGE = 'abmFences', x)
}

cpp_min <- function(x) {
    .Call('_abmFences_cpp_min', PACKAGE = 'abmFences', x)
}
...
cpp_sample_options <- function(W) {
    .Call('_abmFences_cpp_sample_options', PACKAGE = 'abmFences', W)
}
...
cpp_vonmises <- function(N, MU, KAPPA) {
    .Call('_abmFences_cpp_vonmises', PACKAGE = 'abmFences', N, MU, KAPPA)
}
