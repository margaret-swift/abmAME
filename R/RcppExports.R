...
cpp_check_intersection <- function(origin, target, inx, BARRIERS, LOOKUP, INXMAT) {
    .Call('_abmFences_cpp_check_intersection', PACKAGE = 'abmFences', origin, target, inx, BARRIERS, LOOKUP, INXMAT)
}
